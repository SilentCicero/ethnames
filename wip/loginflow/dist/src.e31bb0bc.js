...
},{}],"../node_modules/ethers/dist/ethers.min.js":[function(require,module,exports) {
var define;
...
},{"xhr2":"../node_modules/xhr2/lib/browser.js"}],"../../../../../.npm-global/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"../node_modules/ethjs-extras/node_modules/js-sha3/src/sha3.js":[function(require,module,exports) {
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/hyperapp-styled-components/src/lib/hash.js":[function(require,module,exports) {
...
},{"./lib/hash":"../node_modules/hyperapp-styled-components/src/lib/hash.js","hyperapp":"../node_modules/hyperapp/src/index.js"}],"style.js":[function(require,module,exports) {
"use strict";
...
// colors
var white = '#FFF'; // change global style..

_hyperappStyledComponents.default.injectGlobal(_templateObject());

var _default = _hyperappStyledComponents.default;
exports.default = _default;
},{"hyperapp-styled-components":"../node_modules/hyperapp-styled-components/src/index.js"}],"square.js":[function(require,module,exports) {
...
var paymentForm = null; // get card nonce from payment form
...
function buildForm(_x) {
  return _buildForm.apply(this, arguments);
}

function _buildForm() {
  _buildForm = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(actions) {
...
var _require2 = require('ethjs-extras'),
    call = _require2.call,
    HttpProvider = _require2.HttpProvider;
...
var infuraProvider = new providers.InfuraProvider('mainnet', '7bd5971b072e46f9b6e7ac721938dacc');
var provider = new HttpProvider('https://mainnet.infura.io/v3/7bd5971b072e46f9b6e7ac721938dacc');

var available = function available(ensName) {
  return call({
    provider: provider,
...
var owner = function owner(ensName) {
  return call({
    provider: provider,
...
var resolver = function resolver(ensName) {
  return call({
    provider: provider,
    to: '0x314159265dD8dbb310642f98f50C066173C1259b',
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 10:
                  ...
                  _context.t3 = nullAddress;
                  _context.t0 = _context.t2 === _context.t3;
...
var Wrapper = _style.default.div(_templateObject()); // standard route method
...
var El = function El(type, moreProps) {
  return function () {
    ...
    var inner = _style.default[type](_templateObject2(), function (props) {
...
var NextButton = _style.default.button(_templateObject3(), function (props) {
  return props.available ? colors.primary : 'lightgray';
}); // header
  ...
  return function (state, actions) {
    return (0, _hyperapp.h)(Wrapper, null, (0, _hyperapp.h)(Header, null), (0, _hyperapp.h)(Div, {
      ...
      return (0, _hyperapp.h)(Div, {
        ...
        pr: "0px",
        pl: "0px",
        route: "/names/".concat(name)
      }, (0, _hyperapp.h)("div", null, name), (0, _hyperapp.h)(A, {
        href: "#",
        to: "/names/".concat(name)
      }, "transfer / resolve"));
    }), (0, _hyperapp.h)(Div, {
      row: true,
      mt: "20px"
...
},{"@hyperapp/router":"../node_modules/@hyperapp/router/src/index.js","regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js","ethers":"../node_modules/ethers/dist/ethers.min.js","ethjs-extras":"../node_modules/ethjs-extras/lib/index.js","hyperapp":"../node_modules/hyperapp/src/index.js","axios":"../node_modules/axios/index.js","./style":"style.js","./square":"square.js"}],"../../../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
